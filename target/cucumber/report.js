...
formatter.step({
  "name": "que eu entrei \u003cnumero1\u003e na calculadora multiplicacao",
  "keyword": "Given "
});
formatter.step({
  "name": "eu entrei \u003cnumero2\u003e na calculadora multiplicacao",
  "keyword": "And "
});
formatter.step({
  "name": "eu pressionar mult multiplicacao",
  "keyword": "When "
});
formatter.step({
...
formatter.step({
  "name": "que eu entrei 5 na calculadora multiplicacao",
  "keyword": "Given "
});
formatter.match({
  "location": "MultiplicacaoSteps.que_eu_entrei_na_calculadora_multiplicacao$(int)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "eu entrei 10 na calculadora multiplicacao",
  "keyword": "And "
});
formatter.match({
  "location": "MultiplicacaoSteps.eu_entrei_na_calculadora_multiplicacao$(int)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "MultiplicacaoSteps.eu_pressionar_mult_multiplicacao$()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "o resultado da multiplicacao deve ser 50",
  "keyword": "Then "
});
formatter.match({
...
formatter.step({
  "name": "que eu entrei 2 na calculadora multiplicacao",
  "keyword": "Given "
});
formatter.match({
  "location": "MultiplicacaoSteps.que_eu_entrei_na_calculadora_multiplicacao$(int)"
...
formatter.step({
  "name": "eu entrei 8 na calculadora multiplicacao",
  "keyword": "And "
});
formatter.match({
  "location": "MultiplicacaoSteps.eu_entrei_na_calculadora_multiplicacao$(int)"
...
formatter.step({
  "name": "o resultado da multiplicacao deve ser 16",
  "keyword": "Then "
});
formatter.match({
  "location": "MultiplicacaoSteps.o_resultado_da_multiplicacao_deve_ser(int)"
...
formatter.step({
  "name": "que eu entrei 10 na calculadora multiplicacao",
  "keyword": "Given "
});
formatter.match({
  "location": "MultiplicacaoSteps.que_eu_entrei_na_calculadora_multiplicacao$(int)"
...
formatter.feature({
  "name": "Subtracao",
  "description": "  Como um usuario eu quero saber o valor da\n  subtracao de dois numeros\n  para evitar erros simples",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Adicionar dois numeros",
...
formatter.step({
  "name": "que eu entrei para sub \u003cnumero1\u003e na calculadora de sub",
  "keyword": "Given "
});
formatter.step({
  "name": "eu entrei para sub \u003cnumero2\u003e na calculadora de sub",
  "keyword": "And "
});
formatter.step({
  "name": "eu pressionar sub subtracao de sub",
  "keyword": "When "
});
formatter.step({
...
formatter.step({
  "name": "que eu entrei para sub 10 na calculadora de sub",
  "keyword": "Given "
});
formatter.match({
  "location": "SubtracaoSteps.que_eu_entrei_para_sub_na_calculadora_de_sub$(int)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "eu entrei para sub 5 na calculadora de sub",
  "keyword": "And "
});
formatter.match({
  "location": "SubtracaoSteps.eu_entrei_para_sub_na_calculadora_de_sub(int)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "SubtracaoSteps.eu_pressionar_sub_subtracao_de_sub$()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "que eu entrei para sub 8 na calculadora de sub",
  "keyword": "Given "
});
formatter.match({
  "location": "SubtracaoSteps.que_eu_entrei_para_sub_na_calculadora_de_sub$(int)"
...
formatter.step({
  "name": "eu entrei para sub 2 na calculadora de sub",
  "keyword": "And "
});
formatter.match({
  "location": "SubtracaoSteps.eu_entrei_para_sub_na_calculadora_de_sub(int)"
...
formatter.step({
  "name": "o resultado da subtracao deve ser 6",
  "keyword": "Then "
});
formatter.match({
  "location": "SubtracaoSteps.o_resultado_da_subtracao_deve_ser(int)"
...
formatter.step({
  "name": "eu entrei para sub 10 na calculadora de sub",
  "keyword": "And "
});
formatter.match({
  "location": "SubtracaoSteps.eu_entrei_para_sub_na_calculadora_de_sub(int)"
